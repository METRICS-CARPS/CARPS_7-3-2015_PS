...
```{r mean_acc diff}
reportObject <- reproCheck(reportedValue = "0.79", obtained = 0.7919738 , valueType = 'mean')
reportObject <- reproCheck(reportedValue = "0.92", obtained = 0.9137196, valueType = 'mean')
```
...
# Check coding of `prime` type. No difference when we filter on lettered primes (e.g. `Prime = O, M, T`). We do se a difference filtering on `Prime = 2, 4, 8`...
